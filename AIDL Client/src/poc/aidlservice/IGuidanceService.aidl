...
// Copied from the client project.  Unfortunately, copying the interface into the client app's
// codebase is the recommended way of incorporating an AIDL interface into a client project.
// Upcoming changes to Android's build tools (e.g., the new AAR archive format) may change that but
